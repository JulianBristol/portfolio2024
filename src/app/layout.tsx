...
export const metadata: Metadata = {
  ...
  keywords: ["frontend developer", "web designer", "coding skills", "problem solver", "experience-first approach", "UI/UX designer"],
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={crimsonPro.className}>{children}</body>
    </html>
  );
}
